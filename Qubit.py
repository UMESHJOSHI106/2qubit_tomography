...
measurement outcomes. In the context of polarization tomography, density 
matrix reconstruction involves measuring
the polarization of a beam of light in multiple different bases,
and using these measurements to determine the 
elements of the density matrix that describe the polarization 
state of the beam""")
